...
const ContainerForm = () => {
  ...
  return (
    <div>
      ...
      <div className="h-screen lg:flex-row flex flex-col lg:justify-center lg:items-center">
        {popUp && (
              ...
              <div className="w-full">
                {state.activePage > 0 && (
                  <button
                    onClick={() => backHandler()}
                    type="button"
                    className="bg-gray-400 hover:bg-gray-500 duration-200 px-8 py-1 rounded float-left mb-3"
                  >
                    Back
                  </button>
                )}
                {state.activePage === 2 && (
                  <input
                    className="bg-red-500 hover:bg-red-600 duration-200 px-8 py-1 rounded float-right mb-3"
                    type="submit"
                  />
                )}
                {state.activePage < 2 && (
                  <button
                    onClick={() => nextHandler()}
                    type="button"
                    className="bg-green-500 duration-200 hover:bg-green-600 px-8 py-1 rounded float-right mb-3"
                  >
                    Next
                  </button>
                )}
